        ...
        <div class="p-4 bg-white/80 rounded-2xl dark:border-gray-700 mt-14 shadow-xl">
            ...
            <div id="myTabContent" class="flex items-center justify-center mb-4 rounded-2xl backdrop-blur-lg dark:bg-gray-800">
                ...
                <div class="hidden w-full p-4 rounded-lg bg-white dark:bg-gray-800" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    <h1 class="text-2xl mb-6">Tambah Marketing</h1>
                    <form>
                        ...
                        <div class="relative z-0 w-full mb-6 group">
                            ...
                            <label for="floating_password" class="peer-focus:font-medium absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:left-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">No Induk Karyawan</label>
                        </div>
